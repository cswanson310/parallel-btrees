/*
 * This code is borrowed from Carnegie Mellon University's course 15-418
 * I believe it's widely used, but this specific version was taken from
 * assignment 2 from spring 2014
 */
